...
(function() {
  ...
  window.POLYEDGE_CONFIG = window.__POLYEDGE_ENV
    ? { SUPABASE_URL: window.__POLYEDGE_ENV.SUPABASE_URL || defaults.SUPABASE_URL, SUPABASE_ANON_KEY: window.__POLYEDGE_ENV.SUPABASE_ANON_KEY || defaults.SUPABASE_ANON_KEY }
    : defaults;
})();
