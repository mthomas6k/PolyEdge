document.addEventListener('DOMContentLoaded', () => {
  ...
  const cities = [
    ...
    // — 75 additional major cities —
    {n:'Madrid',lat:40.4,lon:-3.7},
    {n:'Rome',lat:41.9,lon:12.5},
    {n:'Milan',lat:45.5,lon:9.2},
    {n:'Amsterdam',lat:52.4,lon:4.9},
    {n:'Brussels',lat:50.8,lon:4.4},
    {n:'Vienna',lat:48.2,lon:16.4},
    {n:'Munich',lat:48.1,lon:11.6},
    {n:'Frankfurt',lat:50.1,lon:8.7},
    {n:'Zurich',lat:47.4,lon:8.5},
    {n:'Geneva',lat:46.2,lon:6.1},
    {n:'Stockholm',lat:59.3,lon:18.1},
    {n:'Oslo',lat:59.9,lon:10.7},
    {n:'Copenhagen',lat:55.7,lon:12.6},
    {n:'Helsinki',lat:60.2,lon:24.9},
    {n:'Dublin',lat:53.3,lon:-6.3},
    {n:'Lisbon',lat:38.7,lon:-9.1},
    {n:'Prague',lat:50.1,lon:14.4},
    {n:'Warsaw',lat:52.2,lon:21.0},
    {n:'Budapest',lat:47.5,lon:19.0},
    {n:'Bucharest',lat:44.4,lon:26.1},
    {n:'Kyiv',lat:50.4,lon:30.5},
    {n:'Athens',lat:37.98,lon:23.7},
    {n:'Beirut',lat:33.9,lon:35.5},
    {n:'Tel Aviv',lat:32.1,lon:34.8},
    {n:'Amman',lat:31.9,lon:35.9},
    {n:'Kuwait City',lat:29.4,lon:47.9},
    {n:'Doha',lat:25.3,lon:51.5},
    {n:'Tehran',lat:35.7,lon:51.4},
    {n:'Baghdad',lat:33.3,lon:44.4},
    {n:'Karachi',lat:24.9,lon:67.0},
    {n:'Lahore',lat:31.5,lon:74.3},
    {n:'Dhaka',lat:23.8,lon:90.4},
    {n:'Colombo',lat:6.9,lon:79.9},
    {n:'Taipei',lat:25.0,lon:121.5},
    {n:'Kuala Lumpur',lat:3.1,lon:101.7},
    {n:'Manila',lat:14.6,lon:121.0},
    {n:'Osaka',lat:34.7,lon:135.5},
    {n:'Ho Chi Minh City',lat:10.8,lon:106.7},
    {n:'Hanoi',lat:21.0,lon:105.8},
    {n:'Guangzhou',lat:23.1,lon:113.3},
    {n:'Shenzhen',lat:22.5,lon:114.1},
    {n:'Chengdu',lat:30.6,lon:104.1},
    {n:'Casablanca',lat:33.6,lon:-7.6},
    {n:'Tunis',lat:36.8,lon:10.2},
    {n:'Algiers',lat:36.7,lon:3.1},
    {n:'Accra',lat:5.6,lon:-0.2},
    {n:'Abidjan',lat:5.4,lon:-4.0},
    {n:'Dakar',lat:14.7,lon:-17.4},
    {n:'Addis Ababa',lat:9.0,lon:38.7},
    {n:'Dar es Salaam',lat:-6.8,lon:39.3},
    {n:'Kampala',lat:0.3,lon:32.6},
    {n:'Kinshasa',lat:-4.3,lon:15.3},
    {n:'Harare',lat:-17.8,lon:31.1},
    {n:'Rio de Janeiro',lat:-22.9,lon:-43.2},
    {n:'Bogotá',lat:4.7,lon:-74.1},
    {n:'Lima',lat:-12.0,lon:-77.0},
    {n:'Santiago',lat:-33.5,lon:-70.7},
    {n:'Guadalajara',lat:20.7,lon:-103.3},
    {n:'Washington DC',lat:38.9,lon:-77.0},
    {n:'Boston',lat:42.4,lon:-71.1},
    {n:'Miami',lat:25.8,lon:-80.2},
    {n:'Atlanta',lat:33.7,lon:-84.4},
    {n:'Houston',lat:29.8,lon:-95.4},
    {n:'Dallas',lat:32.8,lon:-96.8},
    {n:'Seattle',lat:47.6,lon:-122.3},
    {n:'San Francisco',lat:37.8,lon:-122.4},
    {n:'Denver',lat:39.7,lon:-104.9},
    {n:'Vancouver',lat:49.3,lon:-123.1},
    {n:'Montreal',lat:45.5,lon:-73.6},
    {n:'Melbourne',lat:-37.8,lon:145.0},
    {n:'Auckland',lat:-36.9,lon:174.8},
  ];
